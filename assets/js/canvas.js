...
(function () {
    ...
    function eb(g) {
        if (S.fSDec)
            g[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
                S._fTWm && S._fTWm(g);
            });
    }
    function Wa(g, l, v) {
    ...
    function gb(g) {
        if (g._menuButton) g.exportEnabled ? (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), Ka(g._menuButton), (g._menuButton.title = g._cultureInfo.menuText)) : ua(g._menuButton);
            ...
            J(
                ...
                function () {
                    l ||
                    (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColorOnHover, color: g.toolbar.fontColorOnHover }),
                    0 >= navigator.userAgent.search("MSIE") && ha(g._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                g.allDOMEventHandlers,
                !0
            );
            J(
                ...
                function () {
                    l ||
                    (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }),
                    0 >= navigator.userAgent.search("MSIE") && ha(g._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                },
                g.allDOMEventHandlers,
                !0
            );
        ...
        if (g.exportEnabled && g._dropdownMenu) {
            ...
            for (var v = g._dropdownMenu.childNodes, s = [g._cultureInfo.printText, g._cultureInfo.saveJPGText, g._cultureInfo.savePNGText], qa = 0; qa < v.length; qa++)
                ha(v[qa], { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), (v[qa].innerHTML = s[qa]);
        } else
            !g._dropdownMenu &&
            g.exportEnabled &&
            w &&
    ...
    function hb(g) {
        if (!ib) {
            var l = !1,
                v = !1;
            "undefined" === typeof pa.Chart.creditHref ? ((g.creditHref = ga("iuuqr;..b`ow`rkr/bnl.")), (g.creditText = ga("B`ow`rKR/bnl"))) : ((l = g.updateOption("creditText")), (v = g.updateOption("creditHref")));
    ...
    function va(g, l, v) {
        ...
        ((l.style.backgroundColor = g.toolbar.itemBackgroundColor), (l.style.color = g.toolbar.fontColor), (l.style.border = "none"), ha(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        l.getAttribute("state") !== v &&
        (l.setAttribute("state", v),
            l.setAttribute("type", "button"),
            ha(l, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
    ...
    y = Oa.Chart = (function () {
        ...
        function y(a, d, c, b, e, f, p, t, B, k) {
            ...
            a.beginPath();
            B && 0 < t.thickness
                ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - n))
                : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + p.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - p.thickness / 2));
            a.stroke();
                        ...
                        if (b < l && !h) null !== n.dataPoints[q].y && (g = b);
                            ...
                            null === n.dataPoints[q].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                                    ...
                                    0 <= e ? (p[b] ? (p[b] += e) : ((p[b] = e), (B = Math.min(e, B)))) : t[b] ? (t[b] += e) : ((t[b] = e), (k = Math.max(e, k))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    for (B = 0; B < t.dataPoints.length; B++)
                        if (
                            ...
                            0 < B &&
                            (a.axisX.logarithmic
                                ? ((n = b / t.dataPoints[B - 1].x), 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n))
                                : ((n = b - t.dataPoints[B - 1].x), 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)),
                            null !== e &&
                            null !== t.dataPoints[B - 1].y &&
                            (a.axisY.logarithmic
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)
                                for (b = 0; b < f.length; b++)
                                    if (
                                        (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue) ||
                                        (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue) ||
                                        (f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].startValue && this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].end) ||
                                        (f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue && this._axes[p].scaleBreaks.customBreaks[t].endValue <= f[b].end)
                                    )
                                        f.splice(b, 1), b--;
                        f.sort(function (a, b) {
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); t++)
                            (b = a(f[t].start, f[t].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic)),
                                this._axes[p].scaleBreaks.autoBreaks.push(new T(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)),
                        ...
                        for (e = f = 0; e < this._axes.length; e++)
                            (c = this._axes[e]),
                                c.logarithmic
                                    ...
                                    ? ((f = c.minimum / c.viewportMinimum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum * f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum * f), (p = !0))
                                    : c.viewportMaximum > c.maximum &&
                                    ((f = c.viewportMaximum / c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum / f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum / f), (p = !0))
                                    : c.viewportMinimum < c.minimum
                                    ? ((f = c.minimum - c.viewportMinimum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum + f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum + f), (p = !0))
                                    : c.viewportMaximum > c.maximum &&
                                    ((f = c.viewportMaximum - c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum - f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum - f), (p = !0));
        ...
        l.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== A
                            ? ((e = c.y1),
                                (f = c.y2),
                                0 < v
                                    ? ((h = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b), h < e && ((h = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t), (y = h + k > m.point.y)))
                                    : ((h = m.point.y + r / 2 + t + b), h > f - k && ((h = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k), (y = h < m.point.y))))
                            : ((e = Math.max(m.bounds.y1, c.y1)),
                                ...
                                0 < v
                                    ? ((h = Math.max(m.point.y, b)), h < e && ("bubble" === n || "scatter" === n) && (h = Math.max(m.point.y - k - t, c.y1 + t)))
                                    : ((h = Math.min(m.point.y, b)), h > f - k - t && ("bubble" === n || "scatter" === n) && (h = Math.min(m.point.y + t, c.y2 - k - t))),
                                (h = Math.min(h, f)));
                    } else
                        0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? ((A = "auto"), (p = 4)) : 0 <= n.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === n && (A = "inside"),
                            ...
                            "inside" !== A
                                ? ((e = c.x1),
                                    (f = c.x2),
                                    0 > v
                                        ? ((q = m.point.x - ("horizontal" === C ? B : B - r / 2) - p - b), q < e && ((q = "auto" === A ? Math.max(m.point.x, e) + p : e + p), (y = q + B > m.point.x)))
                                        : ((q = m.point.x + ("horizontal" === C ? 0 : r / 2) + p + b),
                                        q > f - B - p - b && ((q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - p : f - B - p), (y = q < m.point.x))))
                                : ((e = Math.max(m.bounds.x1, c.x1)),
                                    Math.min(m.bounds.x2, c.x2),
                                    (b =
                                        0 <= n.indexOf("range") || "error" === n
                                            ? 0 > v
                                            ? Math.max(m.bounds.x1, c.x1) + r / 2 + p
                                            : Math.min(m.bounds.x2, c.x2) - B / 2 - p + ("horizontal" === C ? 0 : r / 2)
                    ...
                    x &&
                    "inside" !== A &&
                    ((0 > n.indexOf("bar") && ("error" !== n || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2) || !y) &&
                    ((0 > n.indexOf("column") && ("error" !== n || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2) || !y) &&
                    ((d.lineWidth = x),
                            ...
                            if (((x = m[u].x.getTime ? m[u].x.getTime() : m[u].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    l || C
                                        ...
                                        (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), (n = k.nullDataLineDashType), c.setLineDash(q)),
                                            c.lineTo(x, s),
                                        w && b.lineTo(x, s))
                                    ...
                                    (c.stroke(),
                                        ...
                                        (g = m[u].lineColor || r),
                                        (c.strokeStyle = g),
                                    c.setLineDash && (m[u].lineDashType ? ((n = m[u].lineDashType), c.setLineDash(N(n, k.lineThickness))) : ((n = k.lineDashType), c.setLineDash(h))));
                        ...
                        for (x = !1, l = 0; l < m.length; l++)
                            if (((u = m[l].getTime ? m[l].x.getTime() : m[l].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))))
                                if ("number" !== typeof m[l].y)
                                    ...
                                    !x &&
                                    (k.connectNullData
                                        ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = q), (n = k.nullDataLineDashType))
                                        : (d(s), (s = []))),
                                        (x = !0);
                                else {
                                    ...
                                    b.setLineDash && (m[l].lineDashType ? ((n = m[l].lineDashType), (s[s.length - 1].newLineDashArray = N(n, k.lineThickness))) : ((n = k.lineDashType), (s[s.length - 1].newLineDashArray = h))));
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (t[b] = u[k].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((n = a.axisY.convertValueToPixel(t[b])), (D = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = n));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                                    (B[b] = u[k].y + (B[b] ? B[b] : 0)), (D = a.axisY.convertValueToPixel(B[b])), (n = "undefined" !== typeof p[b] ? p[b] : q), (p[b] = D);
                        ...
                        for (var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                                    ...
                                    (B[b] = n + ("undefined" !== typeof B[b] ? B[b] : 0)), (D = a.axisY.convertValueToPixel(B[b])), (n = p[b] ? p[b] : q), (p[b] = D);
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: A, y1: C, x2: m, y2: D };
                                b = P(b);
                            ...
                            if (((s = r[g].x.getTime ? r[g].x.getTime() : r[g].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ja)))))
                                if ("number" !== typeof r[g].y) h.connectNullData || ja || d || b(), (ja = !0);
                                    ...
                                    d || ja
                                        ? (!d && h.connectNullData
                                        ? (f.setLineDash &&
                                        (h.options.nullDataLineDashType || (c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                        ((d = l), (c = u), (l = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (l = d), (u = c), (D = m), (c = h.nullDataLineDashType), f.setLineDash(Q)),
                                            f.lineTo(l, u),
                                        w && p.lineTo(l, u))
                                        : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), (D = { x: l, y: u })),
                                            (ja = d = !1))
                                        : (f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && b());
                                    m = { x: l, y: u };
                                    g < r.length - 1 &&
                                    (y !== (r[g].lineColor || v) || c !== (r[g].lineDashType || h.lineDashType)) &&
                                    (b(),
                                        (y = r[g].lineColor || v),
                                        (f.strokeStyle = y),
                                    f.setLineDash && (r[g].lineDashType ? ((c = r[g].lineDashType), f.setLineDash(N(c, h.lineThickness))) : ((c = h.lineDashType), f.setLineDash(aa))));
                        ...
                        for (r = !1; q < n.length; q++)
                            if (((h = n[q].x.getTime ? n[q].x.getTime() : n[q].x), !(h < a.axisX.dataInfo.viewPortMin || (h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))))
                                if ("number" !== typeof n[q].y)
                                    ...
                                    !r &&
                                    (m.connectNullData
                                        ? b.setLineDash && 0 < s.length && (m.options.nullDataLineDashType || !n[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = y), (z = m.nullDataLineDashType))
                                        : (d(), (s = []))),
                                        (r = !0);
                                else {
                                    ...
                                    b.setLineDash && (n[q].lineDashType ? ((z = n[q].lineDashType), (s[s.length - 1].newLineDashArray = N(z, m.lineThickness))) : ((z = m.lineDashType), (s[s.length - 1].newLineDashArray = E))));
                                ...
                                "number" !== typeof r[g].y
                                    ...
                                    : ((l = a.axisX.convertValueToPixel(s)),
                                        ...
                                        d || c
                                            ...
                                            ((d = l), (c = u), (l = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (l = d), (u = c), (D = m), (Q = h.nullDataLineDashType), f.setLineDash(aa)),
                                                f.lineTo(l, Y),
                                                f.lineTo(l, u),
                                            w && (p.lineTo(l, Y), p.lineTo(l, u)))
                                            : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), (D = { x: l, y: u })),
                                                (c = d = !1))
                                            : (f.lineTo(l, Y), w && p.lineTo(l, Y), f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && b()),
                                        (m = { x: l, y: u }),
                                    g < r.length - 1 &&
                                ...
                                if ("number" !== typeof fa.y) z.connectNullData || Y || x || d(), (Y = !0);
                                    ...
                                    x || Y
                                        ...
                                        ((x = k.pop()), (A = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(A), k.push(x), (A = z.nullDataLineDashType), b.setLineDash(aa)),
                                            b.lineTo(h, r),
                                        w && s.lineTo(h, r))
                                        : (b.beginPath(), b.moveTo(h, r), w && (s.beginPath(), s.moveTo(h, r))),
                                            (Y = x = !1))
                                        : (b.lineTo(h, r), w && s.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && s.moveTo(h, r), k.push({ x: h, y: l - ma })));
                                    u = { x: h, y: r };
                                    q < v.length - 1 &&
                                    ...
                                    ((ma = z.getMarkerProperties(z.dataPointIndexes[f], h, r, b)),
                                        p.push(ma),
                                        (f = P(F)),
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))))
                                if ("number" !== typeof fa.y) z.connectNullData || Y || s || d(), (Y = !0);
                                    ...
                                    s || Y
                                        ...
                                        ((s = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(l.x, l.y), k.push(u), k.push(s), (u = z.nullDataLineDashType), b.setLineDash(aa)),
                                            b.lineTo(h, r),
                                        w && A.lineTo(h, r))
                                        : (b.beginPath(), b.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))),
                                            (Y = s = !1))
                                        : (b.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && A.moveTo(h, r), k.push({ x: h, y: x - ba })));
                                    l = { x: h, y: r };
                                    q < y.length - 1 &&
                                    ...
                                    0 !== fa.markerSize &&
                                    (0 < fa.markerSize || 0 < z.markerSize) &&
                                    ((ba = z.getMarkerProperties(q, h, r, b)), t.push(ba), (f = P(G)), w && t.push({ x: h, y: r, ctx: A, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                            ...
                            if (
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(g - y, m),
                                        ...
                                        c.lineTo(g - y, n),
                                        c.stroke(),
                                        ca(c, C, Math.min(k, q), D, Math.max(k, q), x[t].y[0] <= x[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity),
                                    w &&
                                    ((e = P(E)),
                                        (b.strokeStyle = e),
                                        b.moveTo(g - y, m),
                                        ...
                                        b.lineTo(g - y, n),
                                        b.stroke(),
                                        ca(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === u.type &&
                                    (c.moveTo(g - y, m),
                                        c.lineTo(g - y, n),
                                        c.stroke(),
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)
                            if (
                                ...
                                c.save();
                                0 < ba &&
                                (c.beginPath(), (c.strokeStyle = ma), (c.lineWidth = ba), c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(t - G, k), c.lineTo(t - G, g), c.stroke(), c.moveTo(t - G, n), c.lineTo(t - G, m), c.stroke());
                                c.restore();
                                ...
                                ((e = P(O)),
                                    (b.strokeStyle = e),
                                    (b.lineWidth = ba),
                                0 < ba && (b.moveTo(t - E - G, k), b.lineTo(t - E - G, Math.max(g, n)), b.stroke(), b.moveTo(t - E - G, Math.min(g, n)), b.lineTo(t - E - G, m), b.stroke()),
                                    ca(b, D, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                0 < aa && (b.beginPath(), (b.lineWidth = aa), b.moveTo(t + Y / 2, n - fa), b.lineTo(t - Y / 2, n - fa), b.stroke(), b.moveTo(t + Y / 2, g + fa), b.lineTo(t - Y / 2, g + fa), b.stroke()));
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                ...
                                if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: C,
                                        indexKeyword: 0,
                                        point: { x: b ? (D[t].y[1] >= D[t].y[0] ? m : n) : m + (n - m) / 2, y: b ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? h : q },
                                        direction: D[t].y[1] >= D[t].y[0] ? -1 : 1,
                                        bounds: { x1: b ? Math.min(m, n) : m, y1: b ? q : Math.min(q, h), x2: b ? Math.max(m, n) : n, y2: b ? h : Math.max(q, h) },
                                        color: e,
                                        axisSwapped: b,
                                    }),
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: C,
                                            indexKeyword: 1,
                                            point: { x: b ? (D[t].y[1] >= D[t].y[0] ? n : m) : m + (n - m) / 2, y: b ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : h },
                                            direction: D[t].y[1] >= D[t].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(m, n) : m, y1: b ? q : Math.min(q, h), x2: b ? Math.max(m, n) : n, y2: b ? h : Math.max(q, h) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (
                                ...
                                b = h.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: g, x2: t, y2: v };
                                b = P(b);
                            ...
                            if (((u = n[h].x.getTime ? n[h].x.getTime() : n[h].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))))
                                if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                                    ...
                                    q || Q
                                        ...
                                        ((g[g.length - 1].newLineDashArray = E), (z = m.nullDataLineDashType), b.setLineDash(y)),
                                            b.lineTo(r, l),
                                        w && e.lineTo(r, l),
                                            g.push({ x: r, y1: l, y2: s }))
                                        : (b.beginPath(), b.moveTo(r, l), (x = { x: r, y: l }), (g = []), g.push({ x: r, y1: l, y2: s }), w && (e.beginPath(), e.moveTo(r, l))),
                                            (Q = q = !1))
                                        : (b.lineTo(r, l), g.push({ x: r, y1: l, y2: s }), w && e.lineTo(r, l), 0 == h % 250 && d());
                                    u = m.dataPointIds[h];
                                    ...
                                    b.setLineDash &&
                                    (n[h].lineDashType
                                        ? ((z = n[h].lineDashType), (g[g.length - 1].newLineDashArray = N(z, m.lineThickness)), b.setLineDash(g[g.length - 1].newLineDashArray))
                                        : ((z = m.lineDashType), (g[g.length - 1].newLineDashArray = E), b.setLineDash(E))));
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var h = (f = 0); f < d.length - 3; f += 3, h++) {
                            if (l[h].newStrokeStyle || l[h].newLineDashArray)
                                b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (b.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && b.setLineDash(l[h].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                        }
                        d = v(l, 2);
                        b.moveTo(d[0].x, d[0].y);
                        ...
                        for (h = !1; n < m.length; n++)
                            if (((q = m[n].x.getTime ? m[n].x.getTime() : m[n].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !h)))))
                                if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                    ...
                                    b.setLineDash && (m[n].lineDashType ? ((C = m[n].lineDashType), (l[l.length - 1].newLineDashArray = N(C, k.lineThickness))) : ((C = k.lineDashType), (l[l.length - 1].newLineDashArray = D))));
                                    ...
                                    !h &&
                                    (k.connectNullData
                                        ? b.setLineDash && 0 < l.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType) && ((l[l.length - 1].newLineDashArray = z), (C = k.nullDataLineDashType))
                                        : (d(D, x), (l = []), (s = []))),
                                        (h = !0);
                        d(D, x);
                        V.drawMarkers(f);
        ...
        var ga = function (a, d, c, b, e, f, p, g, l) {
            if (!(0 > c)) {
                ...
                a.globalAlpha = g;
                "pie" === e
                    ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, p, !1), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.closePath(), a.fill())
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, p, !1), 0 <= l && a.arc(d.x, d.y, l * c, p, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
            ...
            function d() {
                if (k && m) {
                    ...
                    for (e = 0; e < m.length; e++)
                        (g = h[(c + e) % m.length]), 1 < a && g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u && (f <= a / 2 && !n ? ((g.hemisphere = "right"), f++) : ((g.hemisphere = "left"), (n = !0)));
                    n = !1;
                    for (e = 0; e < m.length; e++)
                        (g = h[(d + e) % m.length]), 1 < b && g.midAngle > (3 * Math.PI) / 2 - u && g.midAngle < (3 * Math.PI) / 2 + u && (p <= b / 2 && !n ? ((g.hemisphere = "left"), p++) : ((g.hemisphere = "right"), (n = !0)));
                }
            }
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        } else if (0 < Math.abs(h[b].center.x - A.x) || 0 < Math.abs(h[b].center.y - A.y)) (h[b].center.x = A.x + e * (1 - a)), (h[b].center.y = A.y + f * (1 - a)), (p = !0);
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    var q = 0,
                        ...
                        t = (q = q = 0);
                    0 > c
                        ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > p && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c < p && (c = -(p - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c)))
                        : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < p && n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + c > g && (c = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + c - g);
                    ...
                    for (g = 1; g < m.length; g++)
                        if (((p = (a - g + h.length) % h.length), h[p].hemisphere !== h[a].hemisphere)) {
                            ...
                            p !== a &&
                            (0 > b(h[p], h[a]) || ("right" === h[a].hemisphere ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))
                        )
                            break;
                        else p = null;
                    t = p;
                    ...
                    0 > c
                        ...
                        null !== g &&
                        ((t = -c),
                            (c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (h[g].indexLabelTextBlock.y + h[g].indexLabelTextBlock.height / 2)),
                        c - t < r && ((p = -t), (g = f(g, p, d + 1)), +g.toFixed(x) > +p.toFixed(x) && (k = c > r ? -(c - r) : -(t - (g - p))))))
                        : 0 < c &&
                        ((g = "right" === n.hemisphere ? q : t),
                            (k = c),
                        null !== g &&
                        ((t = c),
                            (c = h[g].indexLabelTextBlock.y - h[g].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2)),
                        c - t < r && ((p = t), (g = f(g, p, d + 1)), +g.toFixed(x) < +p.toFixed(x) && (k = c > r ? c - r : t - (p - g)))));
                    k &&
                    ((d = n.indexLabelTextBlock.y + k),
                        (c = 0),
                        (c = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2))),
                        n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u
                            ? ((p = (a - 1 + h.length) % h.length),
                                (p = h[p]),
                                (a = h[(a + 1 + h.length) % h.length]),
                                "left" === n.hemisphere && "right" === p.hemisphere && c > p.indexLabelTextBlock.x
                            ...
                            ((p = (a - 1 + h.length) % h.length),
                                (p = h[p]),
                                (a = h[(a + 1 + h.length) % h.length]),
                                "right" === n.hemisphere && "left" === p.hemisphere && c < p.indexLabelTextBlock.x
                                    ? (c = p.indexLabelTextBlock.x + 15)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
                    ...
                    if (-1 !== H) {
                        ...
                        if (u.reversed) for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), (ca = G)) : (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea));
                        else for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea), (ca = G)) : (a.push(L), D.push(V));
        ...
        l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                if ("x" === a)
                    ...
                    return "y" === a
                        ? ea(h, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : (c.yValueFormatString = "#,##0.########"), f._cultureInfo)
                        : "z" === a
                            ? ea(h, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : (c.zValueFormatString = "#,##0.########"), f._cultureInfo)
                            : h;
            });
        };
        oa(F, U);
        F.prototype.setLayout = function () {
            ...
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign)
                (this.orientation = "horizontal"), (c = this.verticalAlign), (f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width), (p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height);
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                ...
                                d >= q.y1 &&
                                d <= q.y2 &&
                                (b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), (g = !0));
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "bubble":
                                s = q.size;
                                r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                r <= s / 2 && (b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: r }), (g = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                s = q.center;
                                ...
                                r > s && r < w && (b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: 0 }), (g = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = q.funnelSection;
                                ...
                                a > f && a < r && (b.push({ dataPoint: h, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), (g = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                                    ...
                                    b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), (g = !0);
                                break;
                            case "candlestick":
                                if (
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, h = a.text.split(" "), b = 0; b < h.length; b++)
                                    (m = h[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (m = this.ctx.measureText(m)), m.width > q && ((v = c), (q = m.width));
                            }
                        c = 0;
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ((this.sessionVariables.labelMaxHeight =
                                            0 === this.labelAngle ? p : Math.min((b - f * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), b)),
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (r.width + d.width) >> 0), (h = this.labelFontSize), q < f))
                                                    b - 2 * f > n &&
                                                    ((n = b - 2 * f),
                                                        b >= 2 * f && b < 2.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = f),
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                                                        (a = this._labels[b].textBlock),
                                    ...
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
                                        ...
                                        (this.labelWrap && !s(this.options.labelMaxWidth)
                                            ...
                                            : ((this.sessionVariables.labelAngle = this.labelAngle),
                                                (this.sessionVariables.labelMaxWidth = m),
                                                (this.sessionVariables.labelMaxHeight = b < 0.9 * g ? 0.9 * g : b),
                                                (this.sessionVariables.labelWrap = this.labelWrap)))
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                                    ...
                                    : this.options.labelWrap
                                        ? ((this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b), (this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = f))
                                        : ((this.sessionVariables.labelMaxHeight = p),
                                            s(this.options.labelMaxWidth),
                                            (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth),
                                            (this.sessionVariables.labelWrap = this.labelWrap));
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 > w; ) {
                    var G = 0,
                        ...
                        O = 0,
                        $ = 0;
                    if (c && 0 < c.length) for (y = [], h = O = 0; h < c.length; h++) y.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), (O += y[h]), (L += c[h] && !m.isNavigator ? c[h].margin : 0);
                    else y.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(y);
                    if (b && 0 < b.length) for (D = [], h = $ = 0; h < b.length; h++) D.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), ($ += D[h]), (Z += b[h] ? b[h].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++)
                            ...
                            ((p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                (L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : n),
                                (g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W)),
                                (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                (L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : n),
                                (k = Math.round(f.y2 - T - e - L)),
                                (c[h].lineCoordinates = { x1: p - U, y1: g, x2: l - U, y2: k, height: Math.abs(k - g) }),
                            "inside" === c[h].labelPlacement &&
                            0 < h &&
                            ((c[h].lineCoordinates.x1 = c[h].lineCoordinates.x1 - (y[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)) + ("outside" === c[h].tickPlacement ? c[h].tickLength : 0)),
                                (c[h].lineCoordinates.x2 = c[h].lineCoordinates.x1 + c[h].lineThickness / 2)),
                                (c[h].bounds = { x1: p - (y[h] + U), y1: g, x2: l, y2: k, width: l - p, height: k - g }),
                    ...
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++)
                            ...
                            ((p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2)),
                                (l = Math.round(p)),
                                (L = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0),
                                (g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W)),
                                (L = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0),
                                (k = Math.round(f.y2 - (T + e + L))),
                                (b[h].lineCoordinates = { x1: p + X, y1: g, x2: p + X, y2: k, height: Math.abs(k - g) }),
                            "inside" === b[h].labelPlacement &&
                            0 < h &&
                            ((b[h].lineCoordinates.x1 = b[h].lineCoordinates.x1 + (D[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)) - ("outside" === b[h].tickPlacement ? b[h].tickLength : 0) - 2),
                                (b[h].lineCoordinates.x2 = b[h].lineCoordinates.x1 + b[h].lineThickness / 2)),
                                (b[h].bounds = { x1: p, y1: g, x2: l + (D[h] + X), y2: k, width: l - p, height: k - g }),
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (h = 0; h < c.length; h++) J = P[w - 1][h] === P[w][h] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (h = 0; h < b.length; h++) K = R[w - 1][h] === R[w][h] ? !0 : !1;
                        else K = !0;
                    }
                    if (r && H && J && K) break;
                    w++;
                ...
                for (N = []; 4 > w; ) {
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++)
                            ...
                            c[h].labelAutoFit &&
                            !s(x) &&
                            (0 < !a.length && (p = 0 > c[h].labelAngle ? Math.max(p, x) : 0 === c[h].labelAngle ? Math.max(p, x / 2) : p),
                            0 < !d.length && (l = 0 < c[h].labelAngle ? l - A / 2 : 0 === c[h].labelAngle ? l - A / 2 : l)),
                    ...
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++)
                            (b[h].lineCoordinates = {}),
                                (p = Math.round(f.x1 + X + e)),
                                (l = Math.round(f.x2 - T - W > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - T - W)),
                            b[h] && b[h].labelAutoFit && !s(y) && (0 < !a.length && (p = 0 < b[h].labelAngle ? Math.max(p, y) : 0 === b[h].labelAngle ? Math.max(p, y / 2) : p), 0 < !d.length && (l -= D / 2)),
                    ...
                    if (c && 0 < c.length) for (n = [], h = U = 0; h < c.length; h++) n.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), (U += n[h] + c[h].margin), (L += c[h].margin);
                    else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(n);
                    if (b && 0 < b.length) for (z = [], h = S = 0; h < b.length; h++) z.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), (S += z[h]), (Z += b[h].margin);
                    ...
                    if (m.panEnabled) for (h = 0; h < c.length; h++) n[h] = s(m.sessionVariables.axisY.height) ? (m.sessionVariables.axisY.height = n[h]) : m.sessionVariables.axisY.height;
                    else for (h = 0; h < c.length; h++) m.sessionVariables.axisY.height = n[h];
                    if (c && 0 < c.length)
                        for (h = c.length - 1; 0 <= h; h--)
                            (g = Math.round(f.y2)),
                                (k = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2)),
                                (c[h].lineCoordinates.y1 = g - (n[h] + c[h].margin + V)),
                                (c[h].lineCoordinates.y2 = g - (n[h] + c[h].margin + V)),
                            "inside" === c[h].labelPlacement &&
                            0 < h &&
                            ((c[h].lineCoordinates.y1 = c[h].lineCoordinates.y1 + n[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0) - ("inside" === c[h].tickPlacement ? c[h].tickLength : 0)),
                                (c[h].lineCoordinates.y2 = c[h].lineCoordinates.y1 + c[h].lineThickness / 2)),
                                (c[h].bounds = { x1: p, y1: g - (n[h] + V + c[h].margin), x2: l, y2: k - (V + c[h].margin), width: l - p, height: n[h] }),
                            c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width),
                                (V += n[h] + c[h].margin);
                    if (b && 0 < b.length)
                        for (h = b.length - 1; 0 <= h; h--)
                            ...
                            "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = k - z[h] + (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)),
                                (b[h].bounds = { x1: p, y1: g + (b[h].margin + G), x2: l, y2: k, width: l - p, height: S }),
                            b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width),
                                (G += z[h] + b[h].margin));
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l), (p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - X : p));
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l), (p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - T : p));
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((l = b[L].lineCoordinates.x2), (p = l - T));
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (h = 0; h < c.length; h++) J = E[w - 1][h] === E[w][h] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (h = 0; h < b.length; h++) K = u[w - 1][h] === u[w][h] ? !0 : !1;
                        else K = !0;
                    }
                    if (r && H && J && K) break;
                    w++;
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            (c.push(n), (l = n.position), (g = n.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            (n = this._labels[k]),
                            n.position < this.viewportMinimum || ((g = n.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += g));
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                                d.moveTo(e, g), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, g), (e = this.scaleBreaks._appliedBreaks[l].endPixel + b);
                ...
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                            d.moveTo(g, e), d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + b), (e = this.scaleBreaks._appliedBreaks[l].endPixel + c);
        ...
        E.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            "axisX" === this.type
                ...
                1 === e / b && ((g = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval)), (e *= g), (b /= g)),
                ...
                ((b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                    ...
                    1 === b && 1 === e
                        ...
                        : 1 === e / b
                        ? ((g = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), (e *= g), (b /= g))
                        : b > e
                            ? ((g = Math.min((b / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), 1 <= e ? (b = e / g) : (e = b * g))
                            : ((g = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= g), 1 !== b && (b /= g)),
                    (f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? (e / b) * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase),
            ...
            ((this.interval = E.getNiceExponent(Math.ceil(Math.log(g) / d) / (a - 1))), (c = E.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
            if (null === this.minimum || null === this.maximum)
                "axisX" === this.type
                    ...
                    ((b = null !== this.minimum ? this.minimum : this.dataInfo.min),
                        ...
                        isFinite(b) || isFinite(e)
                            ...
                            : 1 === e / b
                                ? ((g = Math.pow(this.logarithmBase, this.interval)), (e *= g), (b /= g))
                                : b > e
                                    ? ((g = Math.min(0.01 * (b / e), 5)), 1 <= e ? (b = e / g) : (e = b * g))
                                    : ((g = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= g), 1 !== b && (b /= g))
                    ...
                    if (
                        ((e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0),
                            ...
                            "left" === this.scaleBreaks.parent._position
                                ? ((b = this.chart.plotArea.x1), (g = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
                                : ((b = this.chart.plotArea.x2), (g = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0), (a *= -1)),
                            (this.bounds = { x1: b, y1: e - n / 2, x2: g, y2: l + n / 2 }),
                            this.ctx.moveTo(b, e),
                        "straight" === this.type || ("left" === this.scaleBreaks.parent._position && 0 >= a) || ("right" === this.scaleBreaks.parent._position && 0 <= a))
                    )
                        this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                        s = b;
                        k = e;
                        f = 0.5;
        ...
        $.prototype.render = function (a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    (0 < n && (q.moveTo(b, f), q.lineTo(e, g), q.stroke(), (this._hidden = !1)), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0));
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (g = this.chart.plotArea.y2), (this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: g });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (f = g = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: g + n / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        C = !1;
                        if (this.parent.labels)
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var g = this.chart.axisX[v].convertPixelToValue({ y: d }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                                    (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && l.push(k));
                                k = null;
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                    (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && l.push(k));
                                k = null;
                            }
                    } else {
                        l = [];
                        if (this.chart.axisX)
                            for (v = 0; v < this.chart.axisX.length; v++)
                                for (g = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                                    (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && l.push(k));
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (g = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                    (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && l.push(k));
                    }
        ...
        W.prototype.highlightObjects = function (a) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    "rangeArea" === b.type ||
                    "rangeSplineArea" === b.type
                        ? ((f = b.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                        ...
                        ((f = b.getMarkerProperties(g, e.x1, e.y2, this.chart.overlaidCanvasCtx)),
                            (f.size = Math.max((1.5 * f.size) << 0, 10)),
                            (f.borderColor = f.borderColor || "#FFFFFF"),
                            (f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size)),
                            V.drawMarkers([f])))
                        : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), V.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
        ...
        W.prototype.getToolTipInnerHTML = function (a) {
            ...
            if (g && ((this.content && "function" === typeof this.content) || this.contentFormatter)) (a = { chart: this.chart, toolTip: this.options, entries: a }), (d = this.contentFormatter ? this.contentFormatter(a) : this.content(a));
                ...
                for (var s = null, k = "", l = 0; l < a.length; l++)
                    ...
                    null === d && (d = ""),
                        !0 === this.reversed
                            ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), l < a.length - 1 && (d = "</br>" + d))
                            : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), l < a.length - 1 && (d += "</br>")));
                null !== d && (d = k + d);
            } else {
                c = a[0].dataSeries;
                b = a[0].dataPoint;
        ...
        W.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var g = 0; g < this.chart.data.length; g++) (c = this.chart.data[g]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !s(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
                ...
                drawMarker: function (a, d, c, b, e, f, g, l) {
                    if (c) {
                        ...
                        "circle" === b
                            ...
                            f && c.fill(),
                            l && (g ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
                            : "square" === b
                            ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), l && (g ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
                            : "triangle" === b
                                ? (c.beginPath(),
